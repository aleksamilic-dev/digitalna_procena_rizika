...
export default function PrilogLjTable({ prilogMData, procenaId, onUpdateOpis, readOnly = false }: PrilogLjTableProps) {
    ...
    const allSections = useMemo(() => [
        ...
        { id: '1.3', name: 'Постојање ажурне евиденције о насталим штетама као последицама техничких ризика у пословању' },
        { id: '1.4', name: 'Постојање ажурне евиденције о насталим штетама као последицама финансијских ризика у пословању' },
        { id: '1.5', name: 'Постојање ажурне евиденције о насталим штетама као последицама физичких ризика у пословању' },
        { id: '1.6', name: 'Постојање ажурне евиденције о штетама насталим као последица противправног деловања' },
        ...
        { id: '2.2', name: 'Опремљеност одговарајућом заштитном опремом дефинисане актом о процени ризика на радном месту и у радној средини и евидентирана у прописаним обрасцима' },
        ...
        { id: '3.1', name: 'Постојање могућности и наступања негативних последица на основу: постојања, потпуности и адекватности интерне нормативне регулативе којом се штите подаци и документа (пословне тајне, тајни подаци, подаци о личности и други осетљиви и поверљиви подаци)' },
        ...
        { id: '3.4', name: 'Постојање могућности наступања негативних последица на основу: постојања, потпуности и адекватности интерне регулативе и процедура за мониторинг, закључивања и реализације домаћих и међународних уговора и превенције настанка имовинске штете услед закључења неповољних пословних аранжмана' },
        { id: '3.5', name: 'Постојање могућности наступања негативних последица на основу: постојања, потпуности и адекватности унутрашњих механизама за праћење судских, управних и других спорова и поступака које корисник води' },
        ...
        { id: '3.7', name: 'Постојање могућности наступања негативних последица на основу: постојања неадекватних, непотпуних или противречних закона и осталих прописа који, сами по себи или у вези један са другим, проузрокују тешкоће у погледу законитог функционисања организације и безбедности њеног пословања' },
        { id: '4.1', name: 'Постојање могућности да организација постане објект: имовинског криминалитета' },
        { id: '4.2', name: 'Постојање могућности да организација постане објект: насилничког криминалитета и тежих прекршаја против јавног реда и мира' },
        ...
        { id: '5.1', name: 'Постојање нормативних аката у складу са правном регулативом (правилник о заштити од пожара, односно правила заштите од пожара, план заштите од пожара објекта или подручја)' },
        { id: '5.2', name: 'Постојање категоризације правног лица и организовање у складу са проценом угрожености у складу са прописима' },
        { id: '5.3', name: 'Постојање кадровске и техничке попуњености и квалификованост људства које ради на пословима заштите од пожара у складу са прописима' },
        ...
        { id: '5.5', name: 'Постојање програма основне обуке и евиденција обуке запослених из области заштите од пожара' },
        { id: '5.6', name: 'Постојање евиденција о надзору противпожарне инспекције и постојање наложених мера заштите од пожара' },
        ...
        { id: '7.3', name: 'Постојање категоризације правног лица и организовања у складу са проценом угрожености и правном регулативом' },
        { id: '7.4', name: 'Постојање кадровске и техничке испуњености и квалификованости запослених који раде на пословима заштите од експлозије и рукују експлозивним материјама у складу са правном регулативом' },
        ...
        { id: '7.6', name: 'Постојање програма основне обуке и евиденција обуке запослених из области заштите од експлозија и руковања експлозивним материјама' },
        { id: '7.7', name: 'Постојање евиденција о надзору државне инспекције и наложених мера заштите од експлозије' },
        { id: '8.1', name: 'SRPS A.L2.002, Друштвена безбедност – Услуге приватног обезбеђења – Захтеви и упутство за оцењивање усаглашености' },
        { id: '8.2', name: 'SRPS ISO/IEC 27001, Безбедност информација, сајбер безбедност и заштита приватности – Системи менаџмента безбедношћу информација – Захтеви' },
        ...
        { id: '8.6', name: 'SRPS ISO 18788, Систем менаџмента услугама приватног обезбеђења – Захтеви са упутством за коришћење' },
        { id: '8.7', name: 'SRPS ISO 28000:2022, Безбедност и отпорност – Систем менаџмента безбедношћу – Захтеви' },
        ...
        { id: '9.2', name: 'Постојање доказа о оспособљености запослених за реаговање у случају удеса, периодична провера оспособљености запослених, одговорних лица и адекватна опремљеност одговарајућом опремом за реаговање у ванредним ситуацијама или еколошким инцидентима' },
        ...
        { id: '11.4', name: 'Постојање одређеног лица за послове информационе безбедности и/или ангажовање спољних експерата и да ли је организација урадила ревизију документа сходно законској регулативи' },
